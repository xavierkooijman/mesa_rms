...
const getStaffMembershipCount = async (userId) => {
  const query =
    "SELECT COUNT(user_id) FROM staff WHERE user_id = $1 AND deleted_at IS NULL";
...
module.exports = { getStaffMembershipCount, getStaffByUserId };
